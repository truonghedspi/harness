# Decision Archive — 2026-08-19

Period closed, moved from `harness/DECISIONS.md` on 2026-08-22 to keep files in use under budget
...
Recorded so a future session does not involve them. The full argument maps are in
...
- **Rejected alternative:** build-system-agnostic project detection in v1 — it would make
  `project-router` and `INV-ROUTE-1` speculate before a single Maven case works.
