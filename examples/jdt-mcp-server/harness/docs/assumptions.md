...
| A-006 | A "project" is the directory of the nearest ancestor `pom.xml`, and a multi-module build gets **one** workspace at the reactor root | assumed | multi-module repos get either N instances (memory blow-up) or wrong-scoped results | — | `project-router`, `INV-ROUTE-1`, `INV-ROUTE-3` |
