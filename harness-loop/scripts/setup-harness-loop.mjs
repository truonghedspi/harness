...
const EXTRA_COPIES = [
  ...
  ["scripts/harness-config.mjs", "tools/harness-config.mjs"],
  ...
  ["references/graph-closed-edges.md", "docs/reference/graph-closed-edges.md"],
  ["references/baseline-cache.md", "docs/reference/baseline-cache.md"],
