...
Generated 2026-08-11 00:23:51 from `harness-issues.jsonl`.
...
- **Seen:** 1x, first 2026-08-11, last 2026-08-11
- **Targets:** /var/folders/3z/np7bbr2910zg9tml74w1gyjh0000gn/T/tmp.q9vwKo2xVN/demo-target
...
=== Harness init: Demo ===
=== Maven verification ===
./init.sh: line 46: mvn: command not found
```
