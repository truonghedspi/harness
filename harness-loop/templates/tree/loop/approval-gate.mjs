...
//
// Usage:
//   node loop/approval-gate.mjs --check            # 0 = no approval needed, 10 = request written
//   node loop/approval-gate.mjs --wait [--timeout-min N] [--on-timeout reject|escalate]
//   node loop/approval-gate.mjs --verdict approved|rejected --reason "..."   # for scripted runs
...
function writeRequest(items) {
  ...
  const body = [
    ...
    "whether the behaviour claimed is the behaviour you wanted. These items carry judgement still owed:", "",
